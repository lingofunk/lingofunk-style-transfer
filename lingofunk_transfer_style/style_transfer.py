...
from lingofunk_transfer_style import beam_search, greedy_decoding, config
from lingofunk_transfer_style.config import StyleTransferModelConfig
from lingofunk_transfer_style.vocab import Vocabulary, build_vocab
from lingofunk_transfer_style.accumulator import Accumulator
from lingofunk_transfer_style.options import load_arguments
from lingofunk_transfer_style.file_io import load_sent, write_sent
from lingofunk_transfer_style.utils import *
from lingofunk_transfer_style.nn import *


class StyleTransferModel(object):
    def __init__(self, model_config: StyleTransferModelConfig, vocab):
        dim_y = model_config.dim_y
        dim_z = model_config.dim_z
        dim_h = dim_y + dim_z
...
if __name__ == '__main__':
    ...
    with tf.Session(config=tf_config) as sess:
        model = create_model(sess, args, config.style_transfer, vocab)
